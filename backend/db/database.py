...
ENGINE_REGISTRY = [
    {
        ...
        "huggingface_id": "XXXXRT/GPT-SoVITS-Pretrained",
        "python_version": "3.10",
    ...
    },
    {
        ...
        "huggingface_id": "Qwen/Qwen3-TTS-12Hz-1.7B-Base",
        "python_version": "3.10",
    ...
    },
    {
        ...
        "huggingface_id": "IndexTeam/IndexTTS-2",
        "python_version": "3.10",
    ...
    },
    {
        ...
        "huggingface_id": "YatharthS/LuxTTS",
        "python_version": "3.10",
    ...
    },
    {
        ...
        "huggingface_id": "OpenMOSS-Team/MOSS-TTS",
        "python_version": "3.10",
    ...
    },
    {
        ...
        "huggingface_id": "fishaudio/s2-pro",
        "python_version": "3.10",
    ...
    },
    {
        ...
        "entry_script": "",
        "flash_attention": False,
        "extra_pip": ["omnivoice", "soundfile"],
    },
    {
        "name": "confucius4tts",
        "display_name": "Confucius4-TTS",
        "port": 7870,
        "github_repo": "https://github.com/netease-youdao/Confucius4-TTS.git",
        "model_scope_id": "netease-youdao/Confucius4-TTS",
        "huggingface_id": "netease-youdao/Confucius4-TTS",
        "python_version": "3.10",
        "description": "网易有道多语言跨语言零样本TTS，支持14种语言",
        "min_vram_gb": 8,
        "entry_script": "webui.py",
        "flash_attention": True,
    },
    {
        ...
        "display_name": "LongCat-AudioDiT",
        "port": 7871,
        "github_repo": "https://github.com/meituan-longcat/LongCat-AudioDiT.git",
        "model_scope_id": "meituan-longcat/LongCat-AudioDiT-1B",
        "huggingface_id": "meituan-longcat/LongCat-AudioDiT-1B",
        "python_version": "3.10",
        "description": "美团高保真扩散式TTS，直接在波形潜空间操作",
        "min_vram_gb": 8,
    ...
    {
        "name": "viitorvoice",
        "display_name": "ViiTor Voice",
        "port": 7872,
        "github_repo": "https://github.com/viitor-ai/viitor-voice.git",
        "model_scope_id": "ZzWater/ViiTor-voice-2.0-base",
        "huggingface_id": "ZzWater/ViiTorVoice-NAR",
        "python_version": "3.10",
        "description": "三阶段语音克隆栈，支持中英文零样本TTS",
        "min_vram_gb": 6,
        "entry_script": "gradio_demo.py",
        "flash_attention": False,
    },
    {
        "name": "asr",
